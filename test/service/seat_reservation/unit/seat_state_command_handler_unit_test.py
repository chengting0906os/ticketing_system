...
class TestCalculateSeatIndex:
    ...
    def test_first_seat_first_row(self) -> None:
        ...
        result = SeatFinder._calculate_seat_index(row=1, seat_num=1, seats_per_row=10)
    ...
    def test_last_seat_first_row(self) -> None:
        ...
        # When: Calculate index
        result = SeatFinder._calculate_seat_index(row=1, seat_num=10, seats_per_row=10)
    ...
    def test_first_seat_second_row(self) -> None:
        ...
        # When: Calculate index
        result = SeatFinder._calculate_seat_index(row=2, seat_num=1, seats_per_row=10)
    ...
    def test_middle_seat_middle_row(self) -> None:
        ...
        result = SeatFinder._calculate_seat_index(row=3, seat_num=5, seats_per_row=8)
    ...
    def test_single_seat_per_row(self) -> None:
        ...
        # When: Calculate index
        # Formula: (5-1) * 1 + (1-1) = 4
        result = SeatFinder._calculate_seat_index(row=5, seat_num=1, seats_per_row=1)
    ...
    def test_large_venue(self) -> None:
        ...
        result = SeatFinder._calculate_seat_index(row=20, seat_num=50, seats_per_row=100)
