...
def verify_seating_config_with_availability(step: Step, context: dict[str, Any]) -> None:
...
def verify_all_tickets_have_status(expected_status: str, context: dict[str, Any]) -> None:
