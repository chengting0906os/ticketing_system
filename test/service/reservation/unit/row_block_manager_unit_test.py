...
def _create_manager_with_mock_client(mock_client: MagicMock) -> RowBlockManager:
    mock_kvrocks_client = MagicMock()
    mock_kvrocks_client.get_client.return_value = mock_client
    return RowBlockManager(kvrocks_client=mock_kvrocks_client)
...
class TestBlocksKey:
    ...
    def test_key_format(self) -> None:
        ...
        with patch(f'{_MODULE}._get_key_prefix', return_value=''):
    ...
    def test_key_with_prefix(self) -> None:
        ...
        with patch(f'{_MODULE}._get_key_prefix', return_value='test:'):
...
class TestFindConsecutiveSeats:
    ...
    async def test_find_exact_consecutive_block(self) -> None:
        ...
        manager = _create_manager_with_mock_client(mock_client)
...
class TestAddSeatsToBlocks:
    """Test add_seats_to_blocks method"""
