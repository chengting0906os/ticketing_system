...
def upgrade() -> None:
    ...
    op.create_table(
        'booking_ticket_mapping',
        sa.Column('booking_id', sa.Integer(), nullable=False),
        sa.Column('ticket_id', sa.Integer(), nullable=False),
        sa.PrimaryKeyConstraint('booking_id', 'ticket_id'),
    )
    op.create_index(op.f('ix_booking_ticket_mapping_booking_id'), 'booking_ticket_mapping', ['booking_id'], unique=False)
    op.create_index(op.f('ix_booking_ticket_mapping_ticket_id'), 'booking_ticket_mapping', ['ticket_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_booking_ticket_mapping_ticket_id'), table_name='booking_ticket_mapping')
    op.drop_index(op.f('ix_booking_ticket_mapping_booking_id'), table_name='booking_ticket_mapping')
    op.drop_table('booking_ticket_mapping')
