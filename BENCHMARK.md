...
| 環境              | RPS   | avg     | min    | med     | max   | p90     | p95      | p99      |
| ----------------- | ----- | ------- | ------ | ------- | ----- | ------- | -------- | -------- |
| 本地              | 1,145 | 30.51ms | 1.93ms | 13.15ms | 2.23s | 74.74ms | 121.23ms | 247.18ms |
| ECS (10i/20vCPU)  | 2,355 | 14.86ms | 2.59ms | 5.53ms  | 2.96s | 20.71ms | 44.33ms  | 267.5ms  |
| ECS (60i/120vCPU) | 5,116 | 9.28ms  | 2.38ms | 5.3ms   | 1.24s | 12.89ms | 26.59ms  | 84.9ms   |
