...
from stacks.seat_reservation_service_stack import SeatReservationServiceStack
...
# 6. Seat Reservation Service Stack (Background Kafka consumer + Kvrocks polling)
seat_reservation_service_stack = SeatReservationServiceStack(
    app,
    'SeatReservationServiceStack',
    vpc=aurora_stack.vpc,
    ecs_cluster=aurora_stack.ecs_cluster,
    aurora_cluster_secret=aurora_stack.cluster.secret,
    app_secrets=aurora_stack.app_secrets,
...
seat_reservation_service_stack.add_dependency(aurora_stack)
seat_reservation_service_stack.add_dependency(kvrocks_stack)
seat_reservation_service_stack.add_dependency(kafka_stack)
